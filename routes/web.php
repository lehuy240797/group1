...
Route::post('/feedback', [FeedbackController::class, 'submitTourFeedback'])->name('feedback.submit');
Route::post('/admin/feedback/check-booking', [FeedbackController::class, 'checkBookingCode'])->name('admin.feedback.check-booking');
...
Route::post('/feedback/check', [FeedbackController::class, 'checkBookingCode'])->name('feedback.check');
Route::post('/feedback/submit', [FeedbackController::class, 'submitTourFeedback'])->name('feedback.submit');
...
Route::middleware(['auth', Role::class . ':admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/feedbacks/{id}/reply', [FeedbackController::class, 'reply'])->name('feedbacks.reply');
    Route::post('/feedbacks/{id}/reply', [FeedbackController::class, 'storeReply'])->name('feedbacks.storeReply');
