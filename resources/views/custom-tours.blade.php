    ...
    <div class="relative z-10 container mx-auto py-8 max-w-lg">
        <div class="bg-white bg-opacity-90 shadow-xl rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('custom-tours.store') }}" class="space-y-4" id="custom-tour-form">
                ...
                <div class="grid grid-cols-2 gap-4" data-animate="animate__fadeInUp" style="animation-delay: 0.2s;"
                    class="opacity-0">
                    ...
                    <div class="flex flex-col min-h-[80px]">
                        ...
                        <span class="text-gray-600 text-xs mt-1 block">Lưu ý: Chi phí khách sạn được tính mặc định
                            2người/phòng/ngày. </span>
                    </div>
                </div>
                <span class="text-gray-600 text-xs mt-1 block">Lưu ý: Các chi phí sẽ tăng 50% vào các ngày lễ. </span>

                <!-- Chọn nơi bạn muốn đến (xuất hiện sau khi chọn Điểm đến) -->
                <div id="places-container" class="space-y-2 hidden" data-animate="animate__fadeInUp"
                ...
                <div class="grid grid-cols-2 gap-4" data-animate="animate__fadeInUp" style="animation-delay: 0.6s;"
                    class="opacity-0">
                    <div class="flex flex-col space-y-4">
                        ...
                        <div>
                            <label for="adult_tickets" class="block font-semibold text-gray-700 mb-1 text-sm">Vé người
                                lớn:</label>
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <div>
                            <label for="child_tickets" class="block font-semibold text-gray-700 mb-1 text-sm">Vé trẻ
                                em:</label>
                            <div class="flex items-center space-x-2">
                                <button type="button" onclick="adjustTicket('child_tickets', -1)"
                                    class="bg-blue-500 hover:bg-blue-600 text-white font-bold w-8 h-8 rounded-full flex items-center justify-center transition-all">-</button>
                                <input type="number" name="child_tickets" id="child_tickets" value="0"
                                    min="0" max="4"
                                    class="border border-gray-300 rounded-lg px-3 py-2 w-16 text-center focus:ring-2 focus:ring-blue-500 h-10 text-sm"
                                    oninput="updateTotalCost()">
                                <button type="button" onclick="adjustTicket('child_tickets', 1)"
                            ...
                            <span class="text-gray-600 text-xs mt-1 block">Lưu ý: Trẻ em dưới 12 tuổi.Chi phí chỉ tính 50%
                                vé người lớn (không bao gồm vé máy bay). </span>
                            @error('child_tickets')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <!-- Vé máy bay -->
                <div class="flex flex-col" data-animate="animate__fadeInUp" style="animation-delay: 0.8s;"
                    class="opacity-0">
                ...
                <div data-animate="animate__fadeInUp" style="animation-delay: 1s;" class="opacity-0">
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="phone" class="block font-semibold text-gray-700 mb-1 text-sm">Số điện
                                thoại:</label>
                ...
                <!-- Tổng chi phí -->
                <div class="mt-6 text-center" data-animate="animate__fadeInUp" style="animation-delay: 1.2s;"
                    class="opacity-0">
                ...
                <!-- Nút submit -->
                <div class="text-center" data-animate="animate__fadeIn" style="animation-delay: 1.4s;"
                    class="opacity-0">
